...
weather_2023 = (
    ...
    | beam.Map(lambda fields: [fields[0], fields[1], fields[2], fields[3] if fields[3] else "0", fields[4], fields[5], fields[6], fields[7], fields[8]])
    | beam.Map(lambda fields: ",".join(fields))
    | beam.Distinct()
)
...
table_schema = 'int64_field_0:INTEGER,station_id:STRING,date:INTEGER,PRCP:LOAT,SNOW:LOAT,TAVG:STRING,TMAX:STRING,TMIN:STRING,country_code:STRING,'
